...
SPEC_PROMPT = f"""
ONLY SUGGEST SPECIALIZATIONS FROM THIS LIST {SPEC_LIST.join(",")}
"""
...
def load_config(db_connection):
    ...
    global KB_ID
    global SPEC_LIST #TODO: Add functionality to load it from DB
    ...
    if msgs:
        ...
        #TODO: update the spec list and spec prompt which will be later used by logic.py
